...
public class SoggettiValidator extends QborrrowAbstractValidator<Soggetti> {
    ...
    @Override
    protected void customValidation(UserContext userContext, Set<InvalidConstraint<?>> errors, String propertyPath, Soggetti object, String... groups) {
        ...
        if (!email.matches(emailPattern)) {
            InvalidConstraint<Soggetti> ic =
                new InvalidConstraintImpl<Soggetti>(Soggetti.class, "error.notValid", propertyPath + "email", object, object.getEmail());
            errors.add(ic);
            log.error("indirizzo email non è valido!");
        }
        /*
         * if (log.isDebugEnabled()) {
         * log.debug("Call CustomValidation method for class SoggettiValidator");
         ...
         * if ((dataCompl.after(dateNow))) {
         * InvalidConstraint<Soggetti> ic =
         * new InvalidConstraintImpl<Soggetti>(Soggetti.class, "error.nonNato", propertyPath + "dataUltimaModifica", soggetti,
         * soggetti.getDataUltimaModifica());
         * errors.add(ic);
         * }
         */
        /*
