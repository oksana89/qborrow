...
public class PrestitiAbstractManagerAction extends QborrrowManagerAction {
    ...
    public String edit() {
        ...
        try {
            prestiti = getQborrrowManager().getPrestiti(prestiti.getBeneficiario(), prestiti.getOggetto_prestato());
    ...
    public String delete() {
        try {
            getQborrrowManager().deletePrestiti(prestiti.getBeneficiario(), prestiti.getOggetto_prestato());
            return manageOkMessage();
        } catch (Exception e) {
