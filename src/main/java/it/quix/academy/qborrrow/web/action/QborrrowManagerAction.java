...
public abstract class QborrrowManagerAction extends QuixActionSupport {
    ...
    private static final Log log = LogFactory.getLog(QborrrowManagerAction.class);
    ...
    private String getExceptionParameter(Exception e, String message) {
        ...
        sb.append(" ");
        while (i < QborrrowManagerAction.MAX_EXCEPTION_CAUSEDBY) {
    ...
    public QborrrowUserContext getUserContext() {
        return (QborrrowUserContext) super.getUserContext();
    }
