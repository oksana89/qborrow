if(typeof qborrrowPresent == 'undefined'){
    ...
    var qborrrowApp = angular.module('qborrrow', dependencyArray);
    ...
    qborrrowApp.run(["$templateCache", function($templateCache) {
