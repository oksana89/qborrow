...
var qxQborrrowHttpService = function($http, qborrrowConfig, $timeout) {
	...
	function _getOggettiList(scopeController, form) {
		...
		scopeController.promise = $http({
			...
			url : qborrrowConfig.baseUrl
					+ '/oggetti.action?task=list&reset=true',
	...
	function _getMieiOggettiList(scopeController, form) {
		...
		scopeController.promise = $http({
			method : 'POST',
			url : qborrrowConfig.baseUrl
					+ '/oggetti.action?task=listMieiOggetti',
			data : quixParamSerializer(scopeController.search, 'oggettiSearch.'),
			headers : {
				'Content-Type' : 'application/x-www-form-urlencoded'
			}
	...
	this.deleteOggetti = function(scopeController, labelService) {
		var success = function(data) {
			...
			sweetAlert(labelService.swalSuccDeleteTitle,
					labelService.swalSuccDeleteMessage, "success");
	...
	function _getPrestitiList(scopeController, form) {
		...
		scopeController.promise = $http({
			method : 'POST',
			url : qborrrowConfig.baseUrl
					+ '/prestiti.action?task=list&reset=true',
			data : quixParamSerializer(scopeController.search,
					'prestitiSearch.'),
			headers : {
				'Content-Type' : 'application/x-www-form-urlencoded'
			}
	...
	this.savePrestiti = function(scopeController, form) {
		...
		scopeController.promise = $http({
			method : 'POST',
			url : qborrrowConfig.baseUrl
					+ '/prestiti.action?task=save&reset=true',
			data : quixParamSerializer(scopeController.selectedRow, 'prestiti.'),
			headers : {
				'Content-Type' : 'application/x-www-form-urlencoded'
			}
	...
	function _getSoggettiList(scopeController, form) {
		...
		scopeController.promise = $http({
			method : 'POST',
			url : qborrrowConfig.baseUrl
					+ '/soggetti.action?task=list&reset=true',
			data : quixParamSerializer(scopeController.search,
					'soggettiSearch.'),
			headers : {
				'Content-Type' : 'application/x-www-form-urlencoded'
	...
	this.editSoggettiWithCompleanno = function(scopeController) {
		...
		scopeController.promise = $http({
			method : 'POST',
			url : qborrrowConfig.baseUrl
					+ '/soggetti.action?task=editSoggettiWithCompleanno',
			data : quixParamSerializer(scopeController.selectedRow, 'soggetti.'),
			headers : {
				'Content-Type' : 'application/x-www-form-urlencoded'
			}
	...
	this.saveSoggetti = function(scopeController, form) {
		...
		scopeController.promise = $http({
			method : 'POST',
			url : qborrrowConfig.baseUrl
					+ '/soggetti.action?task=save&reset=true',
			data : quixParamSerializer(scopeController.selectedRow, 'soggetti.'),
			headers : {
				'Content-Type' : 'application/x-www-form-urlencoded'
			}
	...
	this.saveSoggettiCompleanno = function(scopeController, form) {
		var success = function(data) {
			if ((typeof data) == 'string') {
				// Not Managed Server error
				_manageError(data, 0);
		...
		scopeController.promise = $http({
			method : 'POST',
			url : qborrrowConfig.baseUrl
					+ '/soggetti.action?task=saveWithCompleanno&reset=true',
			data : quixParamSerializer(scopeController.selectedRow, 'soggetti.'),
			headers : {
				'Content-Type' : 'application/x-www-form-urlencoded'
			}
	...
	this.getCombo = function(scopeController, name) {
		...
		scopeController.promise = $http({
			method : 'POST',
			url : qborrrowConfig.baseUrl + '/' + name
					+ '.action?task=list&reset=true&' + name + 'Search.page=-1',
			headers : {
				'Content-Type' : 'application/x-www-form-urlencoded'
			}
		});
...
qborrrowApp.service('qxQborrrowHttpService', [ '$http', 'qborrrowConfig',
		'$timeout', qxQborrrowHttpService ]);
