...
<s:url id="checkUrl" action="home" escapeAmp="false">
	...
	<script type="text/javascript" src="<%=request.getContextPath() %>/scripts/qxQborrrowCommonsComponent.js?_<jsp:include page='_version.jsp' />"></script>
	<script type="text/javascript" src="<%=request.getContextPath() %>/scripts/service/qxQborrrowHttpService.js?_<jsp:include page='_version.jsp' />"></script>
	...
	<script type="text/javascript">
		...
		module.constant('qborrrowConfig', {
